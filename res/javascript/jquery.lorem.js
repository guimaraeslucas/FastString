/*
This plugin will generate Lorem Ipsum text for use as dummy texts on webpages.
...
Code from: http://sanderkorvemaker.nl/jquery/jLorem.php
 */
...
(function($) {
  $.fn.lorem = function(options) {
    ...
    lorem[11] ="Morbi vehicula malesuada consectetur. Sed quis tristique tortor, vel vehicula dolor. In sit amet nisi euismod, molestie lectus vel, pretium ligula. Aliquam pretium justo et nibh adipiscing, in ornare nulla lacinia. Aenean vehicula ut neque scelerisque pulvinar. Sed non libero sed odio adipiscing cursus. Quisque lacinia facilisis sapien id sodales. Etiam eget iaculis arcu. Vestibulum sed elementum magna. Etiam purus odio, gravida nec placerat in, mollis eu mi. Curabitur elementum egestas quam sed scelerisque.";
    function makeipsum(){
        var ipsum_text = "";
        for (var i = 0; i < howmany; i++){
            rnd_number=Math.floor(Math.random()*diff + min_num);
        if(options.ptags=="true" && opts.type!=="words"){
            ipsum_text+="<p>";
        }
